    ...
    describe('fromXML', () => {
        ...
        describe('with a Goldman Sachs 053 v2 US file', () => {
            it('should create an instance with valid config', () => {
                ...
                expect(firstTransaction.accountServicerReferenceId).toBe('B20092800002225');
                expect(firstTransaction.paymentInformationId).toBe('RP/GS/CTFILERP0002/CTBA0003');

                // Account Information
                expect(firstTransaction.remittanceInformation).toBe('Sample Unstructured Remittance 123');
                expect(firstTransaction.returnAdditionalInformation).toBe('Status changed to REJECTED : REJECT REVERSAL');

                // Transaction with a Creditor
                const transactionWithCreditor = report.transactions.find((t) => t.messageId === 'ntsub_Of6teoIeoK9HKo');
                ...
                const transactionWithDebtor = report.transactions.find((t) => t.messageId === '20210706MMQFMPU700000106301050FT03');
